...
#~/prj/images
BUILDROOT=$(BASE_DIR)/target
PRJROOT=$(BASE_DIR)/target_rj
export PRJROOT=$(BASE_DIR)/target_rj

CACHE=$(PRJROOT)/cache
ROOTFS_IMAGES=$(PRJROOT)/images/rootfs
EXPORT_SYMBOL=$(PRJROOT)/images/symbol
EXPORT_LIB=$(PRJROOT)/images/rootfs/lib64
...
BR2_SYTLE = BR2_ARCH_IS_64=$(BR2_ARCH_IS_64) BR2_ARCH=$(BR2_ARCH) BR2_aarch64=$(BR2_aarch64) BR2_x86_64=$(BR2_x86_64) BR2_ENDIAN=$(BR2_ENDIAN) \
			...
			CONFIG_DEV_SC_CFG_DIR=$(CONFIG_DEV_SC_CFG_DIR) \
			KCONFIG_dfd=$(KCONFIG_dfd) \
			QATVER=$(QATVER) \
...
RJ_ENVS = \
	...
	PRODUCT_SPEC_FT=$(PRODUCT_SPEC_FT) \
	CROSS=$(CROSS) \
